"""Generate all 10 chapters and the IEEE Research Paper as separate .docx files."""
import re, os
...
DESKTOP = r"C:\Users\sadaf\OneDrive\Desktop"

CHAPTER_FILES = [
    ("Chapter_1_2_Introduction.docx", "chapter_1_2_introduction.md"),
    ("Chapter_3_System_Analysis.docx", "chapter_3_system_analysis.md"),
    ("Chapter_4_System_Design.docx", "chapter_4_system_design.md"),
    ("Chapter_5_Implementation.docx", "chapter_5_implementation.md"),
    ("Chapter_6_Results_and_Discussion.docx", "chapter_6_results.md"),
    ("Chapter_7_Application_Screenshots.docx", "chapter_7_screenshots.md"),
    ("Chapter_8_Software_Testing.docx", "chapter_8_testing.md"),
    ("Chapter_9_Future_Enhancements.docx", "chapter_9_future.md"),
    ("Chapter_10_Conclusion.docx", "chapter_10_conclusion.md"),
    ("Special_Results_and_Analysis_Chapter.docx", "results_analysis_chapter.md"),
    ("ORNAMIS_Research_Paper_FINAL.docx", "research_paper_ieee.md"),
]
...
def style_doc(doc):
    ...
    for i in range(1, 4):
        h = doc.styles[f'Heading {i}'] if f'Heading {i}' in doc.styles else None
        if h:
...
def generate_file(md_filename, docx_filename):
    md_path = os.path.join(ARTIFACTS, md_filename)
    docx_path = os.path.join(DESKTOP, docx_filename)
    ...
    doc.save(docx_path)
    print(f"  [OK] Saved: {docx_filename}")

if __name__ == '__main__':
    print("=" * 55)
    print("  Generating Separate DOCX Chapters and Paper")
    print("=" * 55)
    for docx_name, md_name in CHAPTER_FILES:
        generate_file(md_name, docx_name)
    print(f"\n[DONE] All separate files saved to Desktop!")
