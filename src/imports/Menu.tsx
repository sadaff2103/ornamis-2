...
/**
 * @figmaAssetKey eb8b0e810d46f31255369fc985cb037d1d5fe0fb
 */
...
/**
 * @figmaAssetKey d096777cc8703042ee7c087684b30b1f8d407aa2
 */
...
/**
 * @figmaAssetKey edcb4242e4d1b9e5e091b787095c534f663658bb
 */
...
export default function Menu() {
  return (
    <div className="relative shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] size-full" data-name="MENU">
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.004393658600747585)+(var(--transform-inner-height)*0.9999899864196777)))] items-center justify-center left-1/2 top-0 translate-x-[-50%] w-[calc(1px*((var(--transform-inner-height)*0.004467858467251062)+(var(--transform-inner-width)*0.9999903440475464)))]" style={{ "--transform-inner-width": "1286.6875", "--transform-inner-height": "527.0625" } as React.CSSProperties}>
      ...
      <Necklace1 className="absolute h-[402.615px] left-[703.7px] top-[646.68px] w-[558px]" />
      <Rings1 className="absolute h-[427.406px] left-[43.7px] top-[633.68px] w-[581px]" />
      <Bracelets1 className="absolute h-[425.423px] left-[46.7px] top-[1139.68px] w-[581px]" />
    </div>
  );
}